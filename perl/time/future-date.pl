...
# if you have postgres avalible then the easiest way is to do:
# my $due = $dbh->selectrow_array("SELECT (current_timestamp + '7 days'::interval)::date AS date_in_seven_days");
